...
vsi_nn_graph_t * vnn_CreateYolov8nPose
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /* @attach_Concat_Concat_241/out0_0:out0 */
    attr.size[0] = 116;
    attr.size[1] = 80;
    attr.size[2] = 80;
    attr.size[3] = 1;
    ...
    /* @attach_Concat_Concat_242/out0_1:out0 */
    attr.size[0] = 116;
    attr.size[1] = 40;
    attr.size[2] = 40;
    attr.size[3] = 1;
    ...
    /* @attach_Concat_Concat_243/out0_2:out0 */
    attr.size[0] = 116;
    attr.size[1] = 20;
    attr.size[2] = 20;
    attr.size[3] = 1;
...
error:
    ...
    vnn_ReleaseYolov8nPose( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateYolov8nPose() */

void vnn_ReleaseYolov8nPose
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
