...
///Loaction of pose key point
typedef struct pose_key_point_result_t {
  key_point point[17];                 ///> 17 pose key points
} det_pose_key_point_result_t;
...
typedef struct _DetectResult {
	...
	det_pose_key_point_result_t pose_points[MAX_DETECT_NUM];
