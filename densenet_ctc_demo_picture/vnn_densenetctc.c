...
vsi_nn_graph_t * vnn_CreateDensenetCtc
    (
...
error:
    ...
    vnn_ReleaseDensenetCtc( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateDensenetCtc() */

void vnn_ReleaseDensenetCtc
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
